...
public class Chapter09 {
    ...
    public static final void main(String[] args) {
        System.out.println(shardKey("abbase", "key", 100, 10));
        System.out.println(shardKey("abbase", "key2", 100, 10));
        System.out.println(shardKey("abbase", "key3", 100, 10));
        System.out.println(shardKey("abbase", "key4", 100, 10));
        System.out.println(shardKey("abbase", "key5", 100, 10));
        System.out.println(shardKey("abbase", "key6", 100, 10));
        System.out.println(shardKey("abbase", "key7", 100, 10));
        System.out.println(shardKey("abbase", "12", 100, 10));
        // new Chapter09().run();
    }
    ...
    public void setLocation(Jedis conn, long userId, String country, String state) {
        ...
        int offset = position * 2;  // 一个人占2个字符
    ...
    private int bisectLeft(String[] values, String key) {
        ...
        return index < 0 ? Math.abs(index) - 1 : index; // 这里为什么用绝对值?
    }

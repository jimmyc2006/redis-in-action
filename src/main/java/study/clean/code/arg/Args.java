...
/**
 * @author shuwei
 * @version 创建时间：2017年3月31日 上午9:16:40
 * 处理字符串数组类型参数
 */
public class Args {
    ...
    public static void main(String[] args) throws ArgsException {
        String schema = "l,p#,d*";
        String[] arguments = "-l -p 8288 -d abc123".split("\\s");
        Args argtest = new Args(schema, arguments);
        System.out.println("l:" + argtest.getBoolean('l'));
        System.out.println("p:" + argtest.getInt('p'));
        System.out.println("d:" + argtest.getString('d'));
    }
}